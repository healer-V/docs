      ...
      items: [
        {
          ...
          items: [
            ...
            { text: "1.2 标签与元素模型", link: "/frontend/01-html/04-tag.md" },
            { text: "1.3 元素属性与全局属性", link: "/frontend/01-html/05-attributes.md" },
            { text: "1.4 URL 与资源路径", link: "/frontend/01-html/02-url.md" },
            { text: "1.5 字符编码与字符实体", link: "/frontend/01-html/03-encode.md" },
          ],
        },
        {
          text: "第2章：HTML 文本与结构",
          collapsed: true,
          items: [
            { text: "2.1 HTML 文本标签", link: "/frontend/01-html/06-text.md" },
            { text: "2.2 HTML 列表标签", link: "/frontend/01-html/09-list.md" },
            { text: "2.3 HTML 语义结构", link: "/frontend/01-html/16-semantic-element.md" },
            { text: "2.4 HTML 语义化实践", link: "/frontend/01-html/18-semantic-best-practice.md" },
          ],
        },
        {
          text: "第3章：HTML 资源与嵌入",
          collapsed: true,
          items: [
            { text: "3.1 HTML 超链接", link: "/frontend/01-html/07-link.md" },
            { text: "3.2 HTML 资源声明", link: "/frontend/01-html/11-link-resource.md" },
            { text: "3.3 HTML 图像", link: "/frontend/01-html/08-image.md" },
            { text: "3.4 HTML 音视频", link: "/frontend/01-html/20-html5-multimedia.md" },
            { text: "3.5 HTML iframe", link: "/frontend/01-html/14-iframe.md" },
            { text: "3.6 HTML 脚本", link: "/frontend/01-html/13-script-noscript.md" },
          ],
        },
        {
          text: "第4章：HTML 表格与表单",
          collapsed: true,
          items: [
            { text: "4.1 HTML 表格", link: "/frontend/01-html/10-table.md" },
            { text: "4.2 HTML 表单", link: "/frontend/01-html/12-form.md" },
          ],
        },
        {
          text: "第5章：HTML5 扩展能力",
          collapsed: true,
          items: [
            { text: "5.1 HTML5 核心新特性", link: "/frontend/01-html/19-html5-features.md" },
            { text: "5.2 HTML5 Canvas", link: "/frontend/01-html/21-html5-canvas.md" },
            { text: "5.3 HTML5 Web Storage", link: "/frontend/01-html/23-html5-storage.md" },
          ],
        },
        {
          text: "第6章：HTML 规范与参考",
          collapsed: true,
          items: [
            { text: "6.1 HTML与HTML5对比", link: "/frontend/01-html/38-html-vs-html5.md" },
            { text: "6.2 HTML常用标签参考", link: "/frontend/01-html/15-elements.md" },
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          items: [
            ...
            { text: "1.3 层叠继承优先级", link: "/frontend/02-css/03-inheritance.md" },
            { text: "1.4 CSS 样式计算", link: "/frontend/02-css/04-computation.md" },
          ],
        },
        {
          text: "第2章：CSS 格式化模型",
          collapsed: true,
          items: [
            { text: "2.1 CSS 盒模型", link: "/frontend/02-css/05-box-model.md" },
            { text: "2.2 视觉格式化模型", link: "/frontend/02-css/06-visual-formatting.md" },
            { text: "2.3 Display与文档流", link: "/frontend/02-css/07-display.md" },
            { text: "2.4 定位与层叠", link: "/frontend/02-css/08-positioning.md" },
            { text: "2.5 Flex 布局", link: "/frontend/02-css/09-flex.md" },
            { text: "2.6 Grid 布局", link: "/frontend/02-css/10-grid.md" },
            { text: "2.7 响应式布局", link: "/frontend/02-css/11-responsive.md" },
          ],
        },
        {
          text: "第3章：CSS3 动效",
          collapsed: true,
          items: [
            { text: "3.1 过渡 transition", link: "/frontend/02-css/12-transition.md" },
            { text: "3.2 动画 animation", link: "/frontend/02-css/13-animation.md" },
            { text: "3.3 变换 transform", link: "/frontend/02-css/14-transform.md" },
          ],
        },
        {
          text: "第4章：CSS3 视觉增强",
          collapsed: true,
          items: [
            { text: "4.1 字体与样式", link: "/frontend/02-css/15-fonts.md" },
            { text: "4.2 颜色与背景", link: "/frontend/02-css/16-background.md" },
            { text: "4.3 边框、阴影与圆角", link: "/frontend/02-css/17-border.md" },
            { text: "4.4 渐变与背景增强", link: "/frontend/02-css/18-gradient.md" },
            { text: "4.5 滤镜与混合模式", link: "/frontend/02-css/19-filter.md" },
          ],
        },
        {
          text: "第5章：CSS3 进阶",
          collapsed: true,
          items: [
            { text: "5.1 CSS变量", link: "/frontend/02-css/20-css3variables.md" },
            { text: "5.2 命名与组织", link: "/frontend/02-css/21-naming.md" },
            { text: "5.3 SCSS", link: "/frontend/02-css/22-scss.md" },
            { text: "5.4 Less", link: "/frontend/02-css/23-less.md" },
            { text: "5.5 CSS-in-JS", link: "/frontend/02-css/24-cssinjs.md" },
            { text: "5.6 Tailwind CSS", link: "/frontend/02-css/25-tailwind.md" },
          ],
        },
        {
          text: "第7章：CSS3",
          collapsed: true,
          items: [
            { text: "7.1 CSS3 新特性", link: "/frontend/02-css/26-css3-features.md" },
            { text: "7.2 CSS2 与 CSS3 对比", link: "/frontend/02-css/27-css2-css3.md" },
          ],
        },
      ],
    },
